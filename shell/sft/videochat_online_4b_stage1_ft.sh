...
OUTPUT_DIR='work_dirs/videochat_online_stage1'
...
torchrun \
    ...
    internvl/train/internvl_chat_finetune_online.py \
      --model_name_or_path "MCG-NJU/VideoChatOnline-4B" \
      --local_rank ${NODE_RANK} \
      --conv_style "phi3-chat" \
      --output_dir ${OUTPUT_DIR} \
      --meta_path "data/finetune_videochat2.json""anno_data/finetune_multimage.json" "anno_data/finetune_image.json" \
